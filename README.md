...
E.M.A. needed more than another website. Its emergency control workflow spans calls, radio, responders, ambulance availability, location uncertainty, alarm acknowledgement, case reports and eventual links to systems such as GroupAlarm and sponsored Teltech radios.
...
flowchart LR
    ...
    B -. approval gate .-> G[GroupAlarm adapter]
